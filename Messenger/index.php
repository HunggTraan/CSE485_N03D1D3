...
<p><input type="text" name="pickusername" id="cusername" placeholder="Viết vào đây" class="msginput"></p>
<p class="buttonp"><button onclick="chooseusername()">Bắt đầu thôi</button></p>
</div>
